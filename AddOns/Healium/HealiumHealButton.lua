...
-- NEW CLASSIC TEST CODE
		local subtext = GetSpellSubtext(info3)
		local spellNameWithSuffix 
		if subtext then
			spellNameWithSuffix = spellName .. "(" .. subtext .. ")"
		else
			spellNameWithSuffix = spellName
		end
--
		Healium_DebugPrint("name:", spellName, "subtext:", subtext, "spellNameWithSuffix:", spellNameWithSuffix, "icon:", icon)
